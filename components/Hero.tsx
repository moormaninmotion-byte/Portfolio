      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-center">
        <div className="md:col-span-2 flex justify-center order-1 md:order-1">
          <img
            ...
            alt="Headshot"
            className="object-cover border-44 border-neutral-800 transition-colors duration-300 hover:border-brand-accent shadow-lg"
            loading="lazy"
            decoding="async"
          />
        </div>
        <div className="md:col-span-3 text-center md:text-left order-2 md:order-2">
          <h1 className="font-display text-5xl md:text-xl font-extrabold tracking-tighter leading-tight mb-6">
